...
CHECKPOINT_PATH = "../Logs_from_the_cloud/Sunday-21-01-2024/model_checkpoints/model_epoch_120.pth"
...
M1_Path = join(SAVE_PATH, "DSCMS-B128-E120-L0001-MSELoss-Trainset-Normalization", f"Channel{testChannel}")
...
M2_Path = join(SAVE_PATH, "Bicubic-Trainset-Normalization", f"Channel{testChannel}")
