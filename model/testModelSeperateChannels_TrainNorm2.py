...
CHECKPOINT_PATH = "../Logs_from_the_cloud/Sunday-21-01-2024-3/model_checkpoints/model_epoch_60.pth"
...
normalizationStatistics2 = np.load("calcMeanVar/separatedStatisticsTarget.npy")
normalizationStatistics2[1,:] = np.sqrt(normalizationStatistics2[1,:])
...
M1_Path = join(SAVE_PATH, "DSCMS-B128-E120-L0001-MSELoss-Trainset-Normalization2", f"Channel{testChannel}")
...
M2_Path = join(SAVE_PATH, "Bicubic-Trainset-Normalization2", f"Channel{testChannel}")
