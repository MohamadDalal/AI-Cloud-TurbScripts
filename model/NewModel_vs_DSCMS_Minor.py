...
Checkpoints = [join(MODEL_PATH, "Wednesday-29-11-2023/", CHECKPOINT_PATH),
               join(MODEL_PATH, "Friday-01-12-2023-6/", CHECKPOINT_PATH)]
Titles = ["Bicubic", "Modified\nSimple SR", "DSC\MS with\nPixle Shuffle"]
...
fig.savefig("FinalReportFigures/NewModel_vs_DSCMS_Minor/Figure.png", dpi=400, bbox_inches='tight')
with open("FinalReportFigures/NewModel_vs_DSCMS_Minor/Stats.txt", "w") as f:
    f.write("MSE\n")
    for i in range(3):
