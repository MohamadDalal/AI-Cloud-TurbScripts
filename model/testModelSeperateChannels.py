...
M1_Path = join(SAVE_PATH, "OldModel-B128-E30-L0001-MSELoss-OldData-FixedPSNR-FixedBlur", f"Channel{testChannel}")
...
M2_Path = join(SAVE_PATH, "Bicubic-OldData-FixedPSNR-FixedBlur", f"Channel{testChannel}")
