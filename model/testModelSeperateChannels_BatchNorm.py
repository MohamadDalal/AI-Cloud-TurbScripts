    ...
    with torch.no_grad():
        ...
        for index, batch in enumerate(testing_data_loader):
            ...
            for i in range(prediction.shape[1]):
                prediction[:,i,...] = batchStatistic[1,i]*prediction[:,i,...]+batchStatistic[0,i]
...
CHECKPOINT_PATH = "../Logs_from_the_cloud/Sunday-21-01-2024-2/model_checkpoints/model_epoch_120.pth"
...
M1_Path = join(SAVE_PATH, "DSCMS-B128-E120-L0001-MSELoss-Batch-Normalization", f"Channel{testChannel}")
...
M2_Path = join(SAVE_PATH, "Bicubic-Batch-Normalization", f"Channel{testChannel}")
