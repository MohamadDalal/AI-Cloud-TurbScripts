...
predictions_dir = join(getcwd(), "test_logs/PresentationTests/DSCMS-B128-E30-L0001-MSELoss-48x16Data_WithPredictions/Channel(0, 1, 2)/Test_Res")
out_dir = join(getcwd(), "FinalReportFigures/MAE_Diff_48x16")
