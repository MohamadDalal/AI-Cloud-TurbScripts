...
BATCH_SIZE = 1
CHECKPOINT_PATH = "../Logs_from_the_cloud/Friday-01-12-2023-6/model_checkpoints/model_epoch_30.pth"
...
#M1_Path = join(SAVE_PATH, "NewModel-B128-E30-L0001-MIXLoss5-BigData", f"Channel{testChannel}")
M1_Path = join(SAVE_PATH, "DSCMS-B128-E30-L0001-MSELoss-BigData", f"Channel{testChannel}")
...
M2_Path = join(SAVE_PATH, "Bicubic-BigData", f"Channel{testChannel}")
