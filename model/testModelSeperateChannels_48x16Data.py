...
def test(model, channel):
    TEST_Path = join(SAVE_PATH, "DSCMS-B128-E30-L0001-MSELoss-48x16Data_WithPredictions", f"Channel{testChannel}", "Test_Res")
...
CHECKPOINT_PATH = "../Logs_from_the_cloud/Monday-22-01-2024/model_checkpoints/model_epoch_30.pth"
...
M1_Path = join(SAVE_PATH, "DSCMS-B128-E30-L0001-MSELoss-48x16Data", f"Channel{testChannel}")
...
M2_Path = join(SAVE_PATH, "Bicubic-48x16Data", f"Channel{testChannel}")
